package com.web.controller.common.interceptor;
...
public class AuthorityInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(StringUtils.equals(className,"UserManageController") && StringUtils.equals(methodName,"login")){
            log.info("Interceptor: Intercept,className:{},methodName:{}",className,methodName);
            return true;
        }
        ...
        if(user == null || (user.getRole().intValue() != Const.Role.ROLE_ADMIN)){
            ...
            if(user == null){
                if(StringUtils.equals(className,"ProductManageController") && StringUtils.equals(methodName,"richtextImgUpload")){
                    ...
                    out.print(JsonUtil.obj2String(ServerResponse.createByErrorMessage("Interceptor, need to login" + loginToken)));
                }
            }else{
                if(StringUtils.equals(className,"ProductManageController") && StringUtils.equals(methodName,"richtextImgUpload")){
                    Map resultMap = Maps.newHashMap();
                    ...
                    out.print(JsonUtil.obj2String(ServerResponse.createByErrorMessage("Interceptor, please login admin")));
                }
            }
            out.flush();
            out.close();
